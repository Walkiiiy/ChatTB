python AssumerSFTTest_Loss.py \
    ...
    --fine_tuned_models /home/ubuntu/walkiiiy/ChatTB/Process_model/models--Assumer_Spider3_Bird3/checkpoint-1000 \
    --test_data /home/ubuntu/walkiiiy/ChatTB/Bird_dev/condensed_rules.json \
    --output_dir /home/ubuntu/walkiiiy/ChatTB/Process_model/models--Assumer_Spider3_Bird3/LossTest_1000_Bird_dev \
    --max_samples 100
