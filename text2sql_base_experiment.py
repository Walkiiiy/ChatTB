...
class Text2SQLExperiment:
    ...
    def __init__(self, 
                 ...
                 output_json_path: str = base_path + "/Bird_dev/EXP_base_gpt20b_rules.json",

                # train_json_path: str = base_path + "/Bird_train/train.json",
                #  db_root_path: str = base_path + "/Bird_train/train_databases",
                #  output_json_path: str = base_path + "/Bird_train/EXP_base_Qwen4B.json",
                #
                # train_json_path: str = base_path + "/Spider_train/train.json",
                # db_root_path: str = base_path + "/Spider_train/database",
                # output_json_path: str = base_path + "/Spider_train/EXP_base_Qwen4B.json",

                # train_json_path: str = base_path + "/Spider_dev/res.json",
                # db_root_path: str = base_path + "/Spider_dev/database",
                # output_json_path: str = base_path + "/Spider_dev/EXP_base_Qwen4B_noRules.json",
                # model='Snowflake/Arctic-Text2SQL-R1-7B'
                model='openai/gpt-oss-20b'
                # model='Qwen/Qwen3-Coder-30B-A3B-Instruct'
                # model='/home/ubuntu/walkiiiy/ChatTB/Model/models--Qwen--Qwen3-Coder-30B-A3B-Instruct/snapshots/573fa3901e5799703b1e60825b0ec024a4c0f1d3'
                ):
        """
