...
- **County Code/District Code/School Code**: Numeric identifiers for county, district, and school (integers).  
...
- **NCESDist/NCESSchool**: National Center for Education Statistics IDs (text).  
